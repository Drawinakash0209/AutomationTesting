...
print("Club Signup Feature Test")
...
club = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/div[1]/div[2]/form/div[1]/select/option[4]")))
club.click()
time.sleep(3)
...
print("Test 3: Testing with different passwords ...")
...
print("Test 4:Testing with correct credentials...")
