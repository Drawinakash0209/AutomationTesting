...
print("Sport Signup Feature Test")
name = "Crciket"
email = "apiit-cricket@gmail.com"
password = "12345678"
...
sport = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/div[1]/div[2]/form/div[1]/select/option[5]")))
sport.click()
time.sleep(3)

# Testing with null
print("Test case 1: Testing with null Email")
signup(name, "", password, password_confirmation)
time.sleep(5)
try:
...
signup(name, email, "", password_confirmation)
time.sleep(5)
try:
...
signup(name, email, "0123456789", password_confirmation)
time.sleep(5)
try:
