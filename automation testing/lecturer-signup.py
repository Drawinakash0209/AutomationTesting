...
print("Lecturer Signup Feature Test")
lecturer_school = "Business School"
name = "Jason Charles"
...
def signup(lecturer_school, name, email, password, password_confirmation):
    driver.find_element(By.NAME, "lecturer_school").clear()
    driver.find_element(By.NAME, "lecturer_school").send_keys(lecturer_school)
...
lecturer = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/div[1]/div[2]/form/div[1]/select/option[3]")))
lecturer.click()
time.sleep(3)

# Testing with null
print("Test case 1:Testing with null Email")
signup(lecturer_school, name, "", password, password_confirmation)
time.sleep(5)
try:
...
print("Test case 2: Testing with null Password")
signup(lecturer_school, name, email, "", password_confirmation)
time.sleep(5)
try:
...
print("Test case 3:Testing with different passwords ...")
signup(lecturer_school, name, email,"123456789", password_confirmation)
time.sleep(5)
try:
...
print("Test case 4: Testing with correct credentials...")
signup(lecturer_school, name, email, password, password_confirmation)
