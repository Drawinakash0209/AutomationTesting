...
suppStaff = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/div[1]/div[2]/form/div[1]/select/option[6]")))
suppStaff.click()
time.sleep(3)
...
signup(email, "", password_confirmation)
time.sleep(5)
try:
...
signup(email, "0123456789", password_confirmation)
time.sleep(5)
try:
